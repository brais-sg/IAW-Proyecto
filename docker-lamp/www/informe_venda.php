...
if(mysqli_connect_errno()){
    ...
    if($query == false){
        echo "Por alguna extraña razón no se pueden mostrar los vehículos en venta, vuelve a intentarlo a ver si la siguiente vez funciona<br>";
        echo "Si no, F por la base de datos<br>";
    } else {
        echo "<h2>Informe de vehiculos para venda:</h2>";
