...
echo '
            <form action="modificando_venda.php" method="post" enctype="multipart/form-data" style="border: 1px solid black;">
                ...
                <input type="submit" value="Modificar datos (venda)">
            </form>
        ';

// Volta o menú (Usando submit)
echo '
