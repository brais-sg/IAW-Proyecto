    ...
    if(isset($modelo)){
        ...
        if(mysqli_num_rows($query) > 0){
            ...
            if(isset($cantidade) && !empty($cantidade)){
                $select = sprintf("UPDATE vehiculo_venda SET cantidade='%s' WHERE modelo='%s'", $cantidade, $modelo);
                $query  = mysqli_query($link, $select);
            ...
            if(isset($descricion) && !empty($descricion)){
                $select = sprintf("UPDATE vehiculo_venda SET descricion='%s' WHERE modelo='%s'", $descricion, $modelo);
                $query  = mysqli_query($link, $select);
            ...
            if(isset($marca) && !empty($marca)){
                $select = sprintf("UPDATE vehiculo_venda SET marca='%s' WHERE modelo='%s'", $marca, $modelo);
                $query  = mysqli_query($link, $select);
            ...
            if(isset($precio) && !empty($precio)){
                $select = sprintf("UPDATE vehiculo_venda SET prezo='%s' WHERE modelo='%s'", $precio, $modelo);
                $query  = mysqli_query($link, $select);
            ...
            if(isset($foto) && !empty($foto)){
                $select = sprintf("UPDATE vehiculo_venda SET foto='%s' WHERE modelo='%s'", $foto, $modelo);
                $query  = mysqli_query($link, $select);
